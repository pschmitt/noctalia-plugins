...
stdenvNoCC.mkDerivation {
  ...
  src = lib.fileset.toSource {
    ...
    fileset = lib.fileset.unions [
      ...
      ../../plugins/syncthing/desktop.luau
      ../../plugins/syncthing/launcher.luau
      ../../plugins/syncthing/shortcut.luau
      ../../plugins/syncthing/lib
      ../../plugins/syncthing/assets
      ../../plugins/syncthing/translations
    ];
  };
